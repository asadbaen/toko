    ...
    <div class="page-main-header">
        <div class="main-header-right row m-0">
            <div class="main-header-left">
                <div class="logo-wrapper"><a href="<?php echo base_url('web') ?>"><img class="img-fluid" src="<?php echo base_url() ?>assets/theme/assets/images/logo/logo.png" alt=""></a></div>
            </div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown"><i data-feather="message-square"></i>
                        <ul class="chat-dropdown onhover-show-div p-t-15 p-b-15">
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle mr-3" src="<?php echo base_url() ?>assets/theme/assets/images/user/1.jpg" alt="">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle mr-3" src="<?php echo base_url() ?>assets/theme/assets/images/user/2.jpg" alt="">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid rounded-circle mr-3" src="<?php echo base_url() ?>assets/theme/assets/images/user/4.jpg" alt="">
